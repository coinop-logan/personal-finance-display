...
var $mdgriffith$elm_ui$Element$Input$negateBox = function (box) {
	return {aq: -box.aq, av: -box.av, az: -box.az, aD: -box.aD};
};
...
var $author$project$Graph$buildDayData = function (entries) {
	...
	var buildForDay = F2(
		function (day, entry) {
			...
			return {a2: entry.a2 / 1000, aN: (entry.a9 - entry.a8) / 1000, a9: entry.a9 / 1000, as: day, aP: (entry.a2 + incomingPay) / 1000, bn: entry.bn / 1000};
		});
	return A2(
		$elm$core$List$map,
		function (_v0) {
...
var $author$project$Graph$viewGraph = function (entries) {
	...
	var earnedValues = A2(
		$elm$core$List$map,
		function (d) {
			return _Utils_Tuple2(d.as, d.aP);
		},
		dayData);
	var creditValues = A2(
		$elm$core$List$map,
